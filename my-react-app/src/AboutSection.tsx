      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="bg-[#F8FAFC] rounded-2xl p-8 border border-primary/10">
            <FaEye className="w-5 h-5" />
              <div className="flex items-center gap-2">
                <h3 className="text-xl font-heading font-bold text-black mb-3">Vision</h3>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-accent/10">
            <GiStairsGoal className="w-5 h-5 mb-2" />
            ...
            <div className="bg-white rounded-2xl p-8 text-primary-foreground">
            <GiArcheryTarget className="w-5 h-5 mb-1" />  
